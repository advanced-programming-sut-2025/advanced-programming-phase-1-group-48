...
public enum MixSeedType implements SeedProvider<CropType> {
    SPRING_MIX("Spring Mixed Seeds", Season.SPRING, Arrays.asList(
    ...
    SUMMER_MIX("Summer Mixed Seeds", Season.SUMMER, Arrays.asList(
            CropType.CORN,
            CropType.HOT_PEPPER,
            CropType.RADISH,
            CropType.WHEAT,
    ...
    FALL_MIX("Fall Mixed Seeds", Season.FALL, Arrays.asList(
            CropType.ARTICHOKE,
            CropType.CORN,
            CropType.EGGPLANT,
            CropType.PUMPKIN,
    ...
    WINTER_MIX("Winter Mixed Seeds", Season.WINTER, Collections.singletonList(
