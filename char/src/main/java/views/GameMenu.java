...
public class GameMenu implements AppMenu {
    public void handleInput(String command, Scanner scanner) {
        if (command.startsWith("game new")) {
           ...
           GameMenuController.printMapHelp();
            ...
            GameMenuController.handleCheatThor(command);
        }else if (command.startsWith("show") ||command.startsWith("add")|| command.startsWith("purchase") || command.startsWith("energy") ||
                ...
                command.startsWith("build")||command.startsWith("cheat")||command.startsWith("buy")||command.startsWith("plant")||command.startsWith("howmuch")||
